/*
 ...
 Source Schema         : edu-content

 Target Server Type    : MySQL
 Target Server Version : 80032 (8.0.32)
 File Encoding         : 65001

 Date: 20/01/2024 14:33:52
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课程审核记录' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `course_base`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 122 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '课程基本信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `course_publish_pre`  (
  ...
  `valid_days` int NULL DEFAULT NULL COMMENT '课程有效期天数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '课程预发布' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课程-教师关系表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `mq_message_history` VALUES (1, 'course_publish', '121', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '1', '1', '0', '0');
INSERT INTO `mq_message_history` VALUES (2, 'course_publish', '121', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '1', '1', '0', '0');
INSERT INTO `mq_message_history` VALUES (3, 'course_publish', '121', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '1', '1', '0', '0');
INSERT INTO `mq_message_history` VALUES (17, 'course_publish', '222', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '1', '0', '0', '0');
INSERT INTO `mq_message_history` VALUES (18, 'course_publish', '18', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '1', '0', '0', '0');
INSERT INTO `mq_message_history` VALUES (20, 'course_publish', '18', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '1', '1', '0', '0');
...
CREATE TABLE `teachplan`  (
  ...
  `change_date` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 290 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '课程计划' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `teachplan` VALUES (267, '第1节', 266, 2, NULL, NULL, NULL, NULL, NULL, 1, 2, NULL, 1, '0', NULL, '2023-12-17 15:58:34');
...
CREATE TABLE `teachplan_media`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 58 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课程计划与媒资关系' ROW_FORMAT = DYNAMIC;
