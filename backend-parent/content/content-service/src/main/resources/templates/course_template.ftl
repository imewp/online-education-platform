                            ...
                            <#list model.teachPlans as firstNode>
                                <div class="item">
                                    <div class="title act"><i class="i-chevron-top"></i>${firstNode.pname}
                                        <span class="time">x小时</span></div>
                                    <div class="drop-down" style="height: 260px;">
                                        <ul class="list-box">
                                            <#list firstNode.teachPlanTreeNodes as secondNode>
                                                <li class="active"><a
                                                            href="http://www.51xuecheng.cn/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}"
    ...
    <div class="popup-box">
        ...
        <div class="popup-pay-box">
            ...
            <div class="content">
                ...
                <div class="info">
                    <p class="info-tit">Java编程思想 <span>课程有效期:${model.courseBase.validDays}天</span></p>
