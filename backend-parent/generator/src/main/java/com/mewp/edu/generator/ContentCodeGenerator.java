package com.mewp.edu.generator;
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/backend-parent/generator/src/main/java");
		gc.setAuthor("mewp");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.3.156:3306/edu-" + SERVICE_NAME
